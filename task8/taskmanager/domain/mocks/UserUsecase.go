...
func (_m *UserUsecase) CreateUser(ctx context.Context, user domain.User) string {
...
func (_m *UserUsecase) Loginfunctionality(ctx context.Context, userinfo domain.User) (bool, string) {
