...
func (_m *TaskUsecase) CreateTasks(ctx context.Context, task domain.Task) (*mongo.InsertOneResult, error) {
...
func (_m *TaskUsecase) DeleteTasks(ctx context.Context, id primitive.ObjectID) domain.Task {
...
func (_m *TaskUsecase) GetTaskByID(ctx context.Context, id primitive.ObjectID) (*domain.Task, error) {
	ret := _m.Called(ctx, id)
...
func (_m *TaskUsecase) UpdateTask(ctx context.Context, id primitive.ObjectID, updated domain.Task) (*domain.Task, error) {
